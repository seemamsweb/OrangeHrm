...
public class ExtendListner implements ITestListener {
   ...
   private static ExtentReports extent = ExtendManager.createInstance(System.getProperty("user.dir")+"\\reports\\"+fileName);
   ...
   public void onTestFailure(ITestResult result) {
       ...
       try {
    	   ExtendManager.captureScreenshot();
           testReport.get().fail("<b>" + "<font color=" + "red>" + "Screenshot of failure" + "</font>" + "</b>",
                   MediaEntityBuilder.createScreenCaptureFromPath(ExtendManager.screenshotName)
                           .build());
       } catch (Exception e) {
